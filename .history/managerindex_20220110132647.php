...
<div class='card m-4'>
    ...
    <div class='card-body'>
        ...
        <?php if(!$existsDanhbayte): ?>
            <a class='btn btn-primary' href='http://localhost:8800/?page=managerindex&action=create'>Tạo chỉ mục danhba_yte</a>
        <?php else: ?>
            <a class='btn btn-danger' href='http://localhost:8800/?page=managerindex&action=delete'>Xóa chỉ mục danhba_yte</a>
        <?php endif ?>
    </div>
    <div class='card-body'>
        <div class='alert alert-primary mt-3'>
        ...
        <?php if(!$existsHealthcare): ?>
            <a class='btn btn-primary' href='http://localhost:8800/?page=managerindex&action=create'>Tạo chỉ mục healthcare</a>
        <?php else: ?>
            <a class='btn btn-danger' href='http://localhost:8800/?page=managerindex&action=delete'>Xóa chỉ mục healthcare</a>
        <?php endif ?>
    </div>
</div>