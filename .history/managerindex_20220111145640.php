    ...
    <div class='card-body'>
        <?php
            foreach ($listIndexs as $key => $value) :?>
                ...
                <?php if($action == 'create'.$listsSlug[$key]): ?>
                    <div class='alert alert-success mt-3'>
                        Chỉ mục <?php echo $listIndexs[$key] ?> đã được tạo
                    </div>
                <?php endif; ?>
                <?php if($action == 'delete'.$listsSlug[$key]): ?>
                    <div class='alert alert-danger mt-3'>
                        Chỉ mục <?php echo $listIndexs[$key] ?> đã được xóa
                    </div>
                <?php endif; ?>
            <?php endforeach; ?>
