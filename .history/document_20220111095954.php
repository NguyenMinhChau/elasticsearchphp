...
<div class='card m-4'>
    <div class='card-header text-center d-flex'>
        ...
        <h5 style='margin: auto'>Tạo mới/Cập nhật Document trong Elasticsearch</h5></div>
    <div class='card-body'>
        <form action='#' method='POST' autocomplete="off" id='form-2' name='form-2'>
            ...
            <button type="submit" class="btn btn-danger btnCreateUpdate">Tạo mới | Cập nhật</button>
            <button type="reset" class="btn btn-danger btnCreateUpdate">Reset Form</button>
        </form>
