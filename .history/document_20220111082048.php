<?php
    ...
    $idUpdateDoctor = $_POST['idUpdateDoctor'] ?? null;
...
<div class='card m-4'>
    ...
    <div class='card-body'>
        <form action='#' method='POST' autocomplete='off'>
            ...
            <div class="form-group">
                <label for="id">ID bác sĩ cập nhật</label>
                <input type="text" class="form-control" id="idUpdateDoctor" name='idUpdateDoctor'>
            </div>
        ...
        <form action='#' method='POST' autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="idDoctor" name='idDoctor' value='<?=$idDoctor?>'>
            </div>
            <div class="form-group">
