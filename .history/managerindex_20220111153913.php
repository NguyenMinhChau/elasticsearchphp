<?php
    ...
    $listIndexs = ['healthcare_new','danhba_yte','healthcare','danhba_yte_new'];
    $listIndexsExits = ['$existsHealthcare_new','$existsDanhbayte','$existsHealthcare','$existsDanhbayte_new'];
    $listMessages = ['$msgHealthcare_new','$msgDanhbayte','$msgHealthcare','$msgDanhbayte_new'];
    $listsSlug = ['healthcare_new','danhba_yte','healthcare','danhba_yte_new'];
