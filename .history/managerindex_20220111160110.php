<?php
    ...
    if($indexText){
        ...
        $mgs = 'Tạo mới thành công cho index có tên là '.$indexText;
        $listIndexs[] = $indexText;
        $listIndexsExits[] = '$exists' . $indexText;
        $listMessages[] = '$msg' . $indexText;
        $listsSlug[] = $indexText;
    }
        ...
        <div class='alert alert-primary mt-2'>
            <?php 
                if($mgs != ''){
                    ...
                    echo '<p class="text-center">Copyright &copy; <span><script>new Date().getFullYear()</script></span> Elasticsearch.</p>';
                }
            ?>
        </div>
    </div>
