<?php
    ...
    $mgs = '';
    if($id != null && $idDoctor != null && $fullName != null && $phoneNumber != null && $workPlace != null && $specialist != null && $address != null && $slug != null && $keyword != null){
    ...
    <div class='card-body'>
        <form action='#' method='POST' autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="keyword" name='keyword' placeholder="Từ khóa tìm kiếm" value="<?=$keywords?>">
            </div>
            <div class="form-group">
