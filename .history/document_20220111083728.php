    ...
    <div class='card-body'>
        ...
        <form action='#' method='POST' autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id" name='id' value='<?=$id?>' placeholder="ID tài liệu" disabled>
            </div>
            <div class="form-group">
                <label for="idDoctor">Mã bác sĩ</label>
                <input type="text" class="form-control" id="idDoctor" name='idDoctor' value='<?=$idDoctor?>' placeholder="Mã bác sĩ" disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="slug" name='slug' placeholder="Eg: Nguyen Van A" value="<?=$slug?>" disabled>
            </div>
            <button type="submit" class="btn btn-success">Tạo mới | Cập nhật</button>
        </form>
