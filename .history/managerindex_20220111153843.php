<?php
    ...
    $listIndexs = ['healthcare_new','danhba_yte','healthcare','indexdemeo'];
    $listIndexsExits = ['$existsHealthcare_new','$existsDanhbayte','$existsHealthcare','existsIndexdemeo'];
    $listMessages = ['$msgHealthcare_new','$msgDanhbayte','$msgHealthcare','msgIndexdemeo'];
    $listsSlug = ['healthcare_new','danhba_yte','healthcare','indexdemeo'];
