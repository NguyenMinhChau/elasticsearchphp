<?php
    ...
    //update lại dữ liệu khi cập nhật
    if($id != null && $idDoctor != null && $fullName != null && $phoneNumber != null && $workPlace != null && $specialist != null && $address != null && $slug != null && $keywords != null){
        $params = [
            'index' => 'healthcare_new',
            'type' => '_doc',
...
<div class='card m-4'>
    ...
    <div class='card-body'>
        <form action='#' method='POST' autocomplete='off' id='form-1' name='form-1'>
            <div class="form-group">
                <label for="id">ID Tài liệu cập nhật</label>
                <input type="text" class="form-control" id="idUpdate" name='idUpdate' value='<?=$idUpdate?>'/>
            </div>
            <button type="submit" class="btn btn-danger btnUpdate">Lấy dữ liệu để cập nhật</button>
        </form>
    </div>
</div>
<div class='card m-4'>
    ...
    <div class='card-body'>
        ...
        <form action='#' method='POST' autocomplete="off" id='form-2' name='form-2'>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="idDoctor" name='idDoctor' value='<?=$idDoctor?>' disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="slug" name='slug' value="<?=$slug?>" disabled>
            </div>
