        ...
        <?php
            if($search != '' && count($result['hits']['hits']) > 0){
                ...
                foreach($result['hits']['hits'] as $item){
                    echo '<tr>';
                    echo '<td>'.$item['_id'].'</td>';
                    echo '<td>'.$item['highlight']['name'] ?? $item['_source']['name'].'</td>';
                    echo '<td>'.implode(', ',$item['highlight']['keyWords'] ?? $item['_source']['keyWords']).'</td>';
                    echo '<td>'.$item['highlight']['specialist'] ?? $item['_source']['specialist'].'</td>';
                    echo '</tr>';
