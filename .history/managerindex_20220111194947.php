                ...
                <?php
                    foreach($listIndexs as $key => $value){
                        ...
                        if($listIndexsExits[$key]){
                            echo '<a href="http://localhost:8800/?page=managerelastic&action=delete'.$listsSlug[$key].'" class="btn btn-outline-danger"><i class="bx bx-folder-minus"></i> Xóa chỉ mục</a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                    }
