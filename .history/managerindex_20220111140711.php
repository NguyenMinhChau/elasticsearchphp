...
<div class='card m-4'>
    ...
    <div class='card-body'>
        ...
        <?php
            foreach ($listIndexs as $key => $value) {
                if(!$listMessages[$key]){
                    echo "<a href='managerindex.php?action=create$listsSlug[$key]' class='btn btn-primary'>Tạo chỉ mục $value</a>";
                    echo "<a href='managerindex.php?action=delete$listsSlug[$key]' class='btn btn-danger'>Xóa chỉ mục $value</a>";
                }
            }
        ?>
    </div>
