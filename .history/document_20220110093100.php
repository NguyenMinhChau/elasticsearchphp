...
<div class='card m-4'>
    ...
    <div class='card-body'>
        <form action='#' method='POST' autocomplete="off">
            ...
            <div class="form-group">
                <label for="id">Họ và tên Bác sĩ</label>
            ...
            <div class="form-group">
                <label for="title">Địa chỉ nhà</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="slug" name='slug' placeholder="Từ khóa tìm kiếm" value="<?=$title?>">
            </div>
            <div class="form-group">
