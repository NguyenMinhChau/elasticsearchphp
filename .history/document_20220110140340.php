    ...
    if($id != null && $idDoctor != null && $fullName != null && $phoneNumber != null && $workPlace != null && $specialist != null && $address != null && $slug != null && $keywords != null){
        ...
        $params = [
            ...
            'body' => [
                ...
                'address' => $address,
                'keyWords' => $keywords,
                'slug' => str_replace(' ', '_', $slug) . '_' .$idDoctor,
            ]
        ];
        $client->index($params);
    ...
    <div class='card-body'>
        <form action='#' method='POST' autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="idDoctor" name='idDoctor' disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="workPlace" name='workPlace' placeholder="Eg: " value="<?=$workPlace?>">
            </div>
            <div class="form-group">
